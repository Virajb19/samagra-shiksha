    ...
    return (
        <ScrollView className="flex-1 bg-[#eaf0fb]" contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
            <View className="bg-white rounded-2xl p-5 items-center mb-5" style={{ elevation: 2 }}>
                ...
                <Text className="text-xl font-bold text-[#1a1a2e]">{user?.name || 'NSCBAV Warden'}</Text>
                <View className="flex-row items-center mt-1 gap-1">
                    <Ionicons name="mail-outline" size={14} color="#6b7280" />
                    <Text className="text-sm text-gray-500">{user?.email || ''}</Text>
                </View>
                <View className="bg-[#dbeafe] px-5 py-1.5 rounded-full mt-3">
                    <Text className="text-sm font-semibold text-[#3b82f6]">NSCBAV Warden</Text>
                </View>
            </View>

            <TouchableOpacity className="bg-white rounded-2xl p-4 flex-row items-center mb-3" style={{ elevation: 1 }} onPress={() => router.push('/(protected)/nscbav-warden/edit-personal-details' as any)}>
            ...
            <TouchableOpacity className="bg-white rounded-2xl p-4 flex-row items-center mb-3" style={{ elevation: 1 }} onPress={() => router.push('/(protected)/nscbav-warden/helpdesk' as any)}>
