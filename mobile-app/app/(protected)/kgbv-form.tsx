...
function FormHeader({ onBack }: { onBack: () => void }) {
    return (
        <View style={{ backgroundColor: BLUE, paddingTop: 14, paddingBottom: 24, paddingHorizontal: 18 }}>
            ...
            <Text className="text-white text-[28px] font-extrabold mb-1">KGBV</Text>
            ...
            <View className="flex-1 bg-black/50 items-center justify-center px-6">
                <View className="bg-white rounded-3xl p-6 w-full max-w-sm items-center" style={{ elevation: 10 }}>
                    ...
                    <Text className="text-sm text-gray-500 mt-2 text-center leading-5">
                        You don't have permission to access the KGBV Form, as only KGBV Wardens are authorized.
                    </Text>
                    <TouchableOpacity
                        onPress={onClose}
...
function KGBVFormDataTable({ submissions }: { submissions: KGBVFormSubmission[] }) {
    ...
    return (
        <View className="mt-6 mb-4">
            <Text className="text-lg font-bold text-[#1a1a1a] mb-3">Your KGBV Submissions</Text>
                ...
                >
                    <View className="flex-row items-center mb-2">
                        ...
                        <View className="flex-1">
                            <Text className="text-base font-bold text-[#1a1a1a]">{sub.activity || 'KGBV Submission'}</Text>
...
export default function KGBVFormScreen() {
    ...
    const renderFormContent = () => (
        <View>
            ...
            {/* Activities Dropdown */}
            <Text className="text-[15px] font-bold text-[#1a1a1a] mb-2">Activities *</Text>
            <Controller
                control={control}
                name="activity"
            ...
            />
            {errors.activity && <Text className="text-xs text-red-500 mb-4">{errors.activity.message}</Text>}
