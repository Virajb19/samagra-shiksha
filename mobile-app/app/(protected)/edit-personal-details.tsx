...
import {
  ...
  type EditPersonalDetailsFormData,
} from "../../src/lib/zod";
...
export default function EditPersonalDetailsScreen() {
  ...
  const profileUrl =
    localImageUri || getImagePreviewUrl(user?.profile_image_url);
      ...
      >
        ...
        <View className="mb-5">
          <View className="flex-row bg-[#e5e7eb] rounded-full p-1">
            ...
            >
              <AppText
                className={`text-sm font-semibold ${selectedGender === "MALE" ? "text-white" : "text-gray-500"}`}
              >
                Male
              </AppText>
            </TouchableOpacity>
            ...
            >
              <AppText
                className={`text-sm font-semibold ${selectedGender === "FEMALE" ? "text-white" : "text-gray-500"}`}
              >
                Female
              </AppText>
            </TouchableOpacity>
          ...
          {errors.gender && (
            <AppText className="text-xs text-red-500 mt-1 ml-1">
        ...
        <View className="mb-6">
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <View
                className={`flex-row items-center bg-white rounded-xl border ${errors.phone ? "border-red-500" : "border-[#e5e7eb]"}`}
              >
                <AppText className="text-base text-gray-400 pl-4 pr-2">
                  +91 |
                </AppText>
                <TextInput
