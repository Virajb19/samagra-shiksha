/**
 * IE Resource Person Circulars Tab — 3-state access model.
 */
...
export default function CircularsTabScreen() {
    ...
    const filteredCirculars = circulars?.filter((c: any) => c.title?.toLowerCase().includes(searchQuery.toLowerCase())) || [];
