 ...
 * 
 * Displays profile information and settings options.
 * Matches the headmaster settings screen with navy theme.
 */
            ...
            items: [
                {
                    ...
                    iconColor: '#0d9488',
                    iconBgColor: '#ccfbf1',
                    route: '/(protected)/teacher/view-profile',
                },
                {
                    ...
                    iconColor: '#3b82f6',
                    iconBgColor: '#dbeafe',
                    route: '/(protected)/teacher/edit-personal-details',
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    iconColor: '#8b5cf6',
                    iconBgColor: '#ede9fe',
                    route: '/(protected)/teacher/helpdesk',
                },
                {
                    id: 'faq',
                    title: 'FAQs',
            ...
            items: [
                {
                    ...
                    iconColor: '#ef4444',
                    iconBgColor: '#fee2e2',
                    route: '/(protected)/teacher/notification-settings',
                },
                {
                    id: 'about',
                    title: 'About App',
        ...
        <ScrollView className="flex-1 bg-[#f0f2f8]" contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
            ...
            <View className="bg-[#2c3e6b] rounded-2xl p-5 flex-row items-center mb-6" style={{ shadowColor: '#2c3e6b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 }}>
                ...
                <View className="ml-4 flex-1">
                    <Text className="text-lg font-semibold text-white">{user?.name || 'Teacher'}</Text>
                    <Text className="text-sm text-white/80 font-medium mt-[2px]">Teacher</Text>
                    <Text className="text-[13px] text-white/60 mt-1">{user?.email || 'teacher@school.edu'}</Text>
                </View>
            </View>
