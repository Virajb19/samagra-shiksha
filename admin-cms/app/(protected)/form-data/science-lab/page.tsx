...
const SCIENCE_LAB_COLUMNS = [
    { key: 'school', label: 'School' },
    { key: 'district', label: 'District' },
    { key: 'udise', label: 'UDISE' },
    { key: 'submitted_by_name', label: 'Submitted By' },
    { key: 'kit_teacher_name', label: 'Kit Teacher Name' },
    { key: 'experiments_per_week', label: 'Experiments / Week' },
    { key: 'student_photos', label: 'Student Photos' },
    { key: 'logbook_photos', label: 'Logbook Photos' },
];

const ALL_COLUMNS = [{ key: 'sl', label: 'Sl No.' }, ...SCIENCE_LAB_COLUMNS];
...
export default function ScienceLabFormDataPage() {
            ...
            <motion.div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" variants={itemVariants}>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Science Lab Form Data</h1>
                            <p className="text-slate-500 dark:text-slate-400 text-sm">View submitted form data for Science Lab</p>
                        </div>
                    </div>
            ...
            {isLoading && (
                ...
                >
                    <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <span className="text-slate-500 dark:text-slate-400 text-base">Loading Science Lab form data...</span>
                    </div>
                </motion.div>
            )}
