...
const ALL_COLUMNS = [{ key: 'sl', label: 'Sl No.' }, ...SELF_DEFENSE_COLUMNS];
...
function renderCell(key: string, row: Record<string, unknown>) {
    ...
    // Single photo URL — wrap in array for PhotoCell
...
export default function SelfDefenceFormDataPage() {
            ...
            <motion.div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" variants={itemVariants}>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Self Defence Form Data</h1>
                            <p className="text-slate-500 dark:text-slate-400 text-sm">View submitted form data for Self Defence</p>
                        </div>
                    </div>
            ...
            {isLoading && (
                ...
                >
                    <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <span className="text-slate-500 dark:text-slate-400 text-base">Loading Self Defence form data...</span>
                    </div>
                </motion.div>
            )}
