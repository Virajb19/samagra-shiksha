...
const ALL_COLUMNS = [{ key: 'sl', label: 'Sl No.' }, ...NSCBAV_COLUMNS];
...
export default function NSCBAVFormDataPage() {
            ...
            <motion.div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" variants={itemVariants}>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">NSCBAV Form Data</h1>
                            <p className="text-slate-500 dark:text-slate-400 text-sm">View submitted form data for NSCBAV</p>
                        </div>
                    </div>
            ...
            {isLoading && (
                ...
                >
                    <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <span className="text-slate-500 dark:text-slate-400 text-base">Loading NSCBAV form data...</span>
                    </div>
                </motion.div>
            )}
