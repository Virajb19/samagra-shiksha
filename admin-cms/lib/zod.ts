...
const CIRCULAR_ALLOWED_FILE_TYPES = [
  "image/png",
  "image/jpeg",
  "image/jpg",
  "application/pdf",
...
export type GeneralNotificationSchema = z.infer<
  typeof generalNotificationSchema
>;
export type InvitationNotificationSchema = z.infer<
  typeof invitationNotificationSchema
>;
...
export const activityFormDateSchema = z
  .object({
